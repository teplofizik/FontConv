...
namespace FontConv
{
    class FontToC
    {
        ...
        class CharBlock { public byte Char;  public int Index; public int Length; public CharBlock(byte Char, int Offset, int Len) { this.Char = Char; Index = Offset; Length = Len; } }
 ...
 //               int offsetx = _Index[int];
        ...
        public void SaveFile(string filename, string fontname)
        {
            ...
            string temp = string.Format("const __flash uint8_t {0:S}_index [{1:D}] = ", fontname, _Index.Count * 2) + "{";
            _text += temp;
            ...
            temp = string.Format("const __flash uint8_t {0:S}_data [{1:D}] = ", fontname, _Data.Count * 2) + "{" + "\r\n" + "   ";
            _text += temp;
